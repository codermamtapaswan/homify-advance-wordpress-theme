    ...
    <footer>
      <div class="upper-part">
        <div class="container">
          <div class="row vcenter row-gap ">
            <div class="col-lg-3">
              <div class="trending-topics"><span>TRENDING TOPICS</span></div>
            </div>
            <div class="col-lg-9">
            ...
            <div class="col-lg-12">
              <div class="copywrite">
                <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 1.667c4.6 0 8.333 3.733 8.333 8.333s-3.734 8.334-8.334 8.334A8.336 8.336 0 0 1 .666 10c0-4.6 3.733-8.333 8.333-8.333m0 1.667A6.665 6.665 0 0 0 2.332 10a6.665 6.665 0 0 0 6.666 6.667A6.665 6.665 0 0 0 15.666 10a6.665 6.665 0 0 0-6.667-6.666m0 2.5c1.516 0 2.844.81 3.573 2.023l-1.429.857A2.499 2.499 0 0 0 6.84 11.26a2.5 2.5 0 0 0 4.304.028l1.429.857A4.166 4.166 0 0 1 4.833 10c0-2.3 1.866-4.166 4.166-4.166" fill="#fff" />
                </svg>
    ...
    <button title="back to top button" id="scroll_to_top">
      <svg width="16" fill="#fff" viewBox="0 -4.5 20 20" xmlns="http://www.w3.org/2000/svg">
        <g stroke-width="0" />
